...
root_total = '/content/Kaggle_NCFM/dataset/train'
...
for fish in FishNames:
    ...
    for k in range(1, n_fold + 1):  # k 取值为 1， 2， 3， 4， 5
        root_train = '/content/Kaggle_NCFM/dataset/train_split' + str(k)
        root_val = '/content/Kaggle_NCFM/dataset/val_split' + str(k)
        nbr_train_samples = 0
        nbr_val_samples = 0
